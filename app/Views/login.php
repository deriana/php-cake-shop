...
<head>
    ...
    <title>Login &mdash; Cake Shop</title>
...
<body>
        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch justify-content-center">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 bg-white">
                    <div class="p-4 m-3">
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Cake Shop Amanda</span></h4>
                        <form method="POST" action="/cake-shop/?act=login-auth" class="needs-validation" novalidate="">
    ...
    <script src="\cake-shop\assets\js\stisla.js"></script>
    <script src="\cake-shop\assets\js\scripts.js"></script>
    <script src="\cake-shop\assets\js\custom.js"></script>
</body>
